...
In order to estimate the errors introduced by PolConvert, histograms of the parameter residuals (after the mean subtraction) are plotted. Below are the histograms for all of the baselines: \\
